...
//Constructors
  ...
  Int_t THaCodaFile::codaOpen(const char* fname, Int_t /* mode */ ) {
      ...
      // cout << "codaOpen 1111 "<<endl;
       Int_t EvioVersion;
       Int_t status2 = S_SUCCESS; EvioVersion=3; // evIoctl(handle, d_v, &EvioVersion);
       //cout << "codaOpen 2222 "<<endl;
       fCodaVersion = 0;
       ...
       //cout << "codaOpen 3333, status "<<status<<endl;
       staterr("open",status);
