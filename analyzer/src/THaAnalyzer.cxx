...
Int_t THaAnalyzer::PhysicsAnalysis( Int_t code )
{
  ...
  //cout << "physics analysis (1111)"<<endl;
 ...
 errexit:
  ...
  //cout << "physics analysis (2222) code = "<<code<<endl;
